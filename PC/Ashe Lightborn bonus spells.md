...
let str ='~~~meta-bind \n 	INPUT[multiSelect(title(Spells level 1), option("Bless") ,option("Heros Defiance"), option("Compel Hostility") , option("Protection From Evil") , option("Diagnose Disease")):SpellsCast] \n ~~~ \n' +
'\n2: ';
dv.paragraph(str);
```
